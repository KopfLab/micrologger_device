...
// new replcement for state
#define STATE_STATUS_VARIABLE        "status" // name of the particle exposed state status variable
#define STATE_CONTROLLER_VARIABLE    "controller" // name of the particle exposed state controller variable
#define STATE_COMPONENTS_VARIABLE    "components" // name of the particle exposed state components variable
...
class LoggerController {
  ...
  protected:
    ...
    char state_status_variable[STATE_INFO_MAX_CHAR];
    char state_status_variable_buffer[STATE_INFO_MAX_CHAR-50]; // FIXME not sure this is needed
    char state_controller_variable[STATE_INFO_MAX_CHAR]; // FIXME: assemble from state_variable and LCD state variable
    char state_controller_variable_buffer[STATE_INFO_MAX_CHAR-50]; // FIXME not sure this is needed
    char state_components_variable[STATE_INFO_MAX_CHAR]; // FIXME this should happen at thec omponent level - need to manage total length of the variable though!
    char state_components_variable_buffer[STATE_INFO_MAX_CHAR-50];
  ...
  public:
    ...
    void addToStateStatusVariableBuffer(char* info);
    void addToStateControllerVariableBuffer(char* info);
    void addToStateComponentsVariableBuffer(char* info);
